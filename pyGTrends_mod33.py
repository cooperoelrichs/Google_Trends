...
class pyGTrends(object):
    ...
    def __init__(self, username, password):
        ...
        self.url_PrefCookie = 'http://www.google.com' #ADDED================
    ...
    def _connect(self):
        ...
        #resp = resp.readall().decode(encoding)
        #print(resp)
        
        #resp = re.sub(r'\s\s+', ' ', str(resp)) #ADDED================
        resp = re.sub(r'\s\s+', ' ', resp) #ADDED================
        ...
        self.opener.open(self.url_PrefCookie)  #ADDED================
    ...
    def csv(self, section="main", as_list=False):
        ...
        #CHANGED==============================================
        segments = self.raw_data.split('Interest over time\n')
